...
<head>
    ...
    <style>
        ...
        .table tbody tr:hover td { background: #E8EEF6; }

        /* バッジ */
        .badge { border-radius: 999px !important; font-size: 0.72rem !important; font-weight: 700 !important; }
        .badge.bg-warning { background: #FBF1DF !important; color: #7A4D0A !important; }
        .badge.bg-success  { background: #E4F2EE !important; color: #1A5C45 !important; }
        .badge.bg-danger   { background: #FAE7E5 !important; color: #7A2820 !important; }
